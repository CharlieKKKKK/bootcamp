...
public class CharlieCheckException {
  public static void main(String[] args) {
    // Checked exception - compiler requires the exception to be handled during the
    // compile time
    ...
    // The method caller still need to handle the unchecked exception even the
    // method throws alreay.
