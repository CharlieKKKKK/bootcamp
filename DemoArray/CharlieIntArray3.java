...
public class CharlieIntArray3 {
  public static void main(String[] args) {
    ...
    int[] arr2 = new int[] { 100, 4, 100, 500, -20 };
    int targetIndex = 1;
 ...
 /*    char[] arr7 = new char[s.length()];
    ...
    String result4 = str4.replace('a','c');// replace aby c
    System.out.println("str4=" + str4);// result=abcabcabcabcabc
    System.out.println("result4=" + result4);// result=cbccbccbccbccbc

    System.out.println(str4.replace("ab","ij")); //ijicjcijcijcijc
  }
}
