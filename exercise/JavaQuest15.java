...
public class JavaQuest15 {
  ...
  public static int percentageLetter(String s, char letter) {
    ...
    BigDecimal x = BigDecimal.valueOf(count);
    BigDecimal y = BigDecimal.valueOf(s.length());
    BigDecimal z = BigDecimal.valueOf(100);
    result = x.divide(y,2,RoundingMode.HALF_UP).multiply(z);
