package DemoClass.literalpool;

public class CharlieString {
  public static void main(String[] args) {// ***** equals 係check 個 value ， == 係check 個 object // nul = 空指針 ,冇指任何objest
    // objest reference???
    ...
    // Java Compiler would NOT look at the value assigned to object reference during
    // the compile time
    // String str6 = null;
