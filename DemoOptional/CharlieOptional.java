...
public class CharlieOptional {
  public static void main(String[] args) {
    ...
    Account account = CharlieOptional.setup(1, 0.0d);
    account.credit(10.0d);

    Account account2 = CharlieOptional.setup(0, 0.0d); // accountNo 0 is not allowed -> return null
    ...
    CharlieOptional.setup2(2, 0.0d).ifPresent(acct -> {
      acct.credit(1000.d);
    });

    // Approach 2 to handle Optional return value
    Optional<Account> oa = CharlieOptional.setup2(3, 0.0d);
    if (oa.isPresent()) {
